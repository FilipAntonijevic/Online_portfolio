    ...
    <>
      ...
      >
        {repo.name === 'Honey_Cosmetics' ? (
          <img 
            src={import.meta.env.BASE_URL + "images_webp/project_images/Honey_Cosmetics.webp"} 
            alt={repo.name}
          ...
          <img 
            src={import.meta.env.BASE_URL + "images_webp/project_images/Mammoth_island.webp"} 
            alt={repo.name}
            style={{ maxWidth: '100%', maxHeight: '100%', objectFit: 'contain', transform: `translateX(-50%) scale(${getScale(repo.name)})`, transformOrigin: 'bottom center', position: 'absolute', left: '50%', bottom: '6px' }}
          />
        ) : repo.name === 'Tavern_Tower' ? (
          <img 
            src={import.meta.env.BASE_URL + "images_webp/project_images/Tavern_tower.webp"} 
            alt={repo.name}
            style={{ maxWidth: '100%', maxHeight: '100%', objectFit: 'contain', transform: `translateX(-50%) scale(${getScale(repo.name)})`, transformOrigin: 'bottom center', position: 'absolute', left: '50%', bottom: '6px' }}
          />
        ) : repo.name === 'Optimal_block_packing' ? (
          <img 
            src={import.meta.env.BASE_URL + "images_webp/project_images/Block_packing.webp"} 
            alt={repo.name}
            style={{ maxWidth: '100%', maxHeight: '100%', objectFit: 'contain', transform: `translateX(-50%) scale(${getScale(repo.name)})`, transformOrigin: 'bottom center', position: 'absolute', left: '50%', bottom: '6px' }}
          />
        ) : repo.name === 'Mastermind_best_starting_move_proof' ? (
          <img 
            src={import.meta.env.BASE_URL + "images_webp/project_images/Mastermind_proof.webp"} 
            alt={repo.name}
            style={{ maxWidth: '100%', maxHeight: '100%', objectFit: 'contain', transform: `translateX(-50%) scale(${getScale(repo.name)})`, transformOrigin: 'bottom center', position: 'absolute', left: '50%', bottom: '6px' }}
          />
        ) : repo.name === 'score_sheet' ? (
          <img 
            src={import.meta.env.BASE_URL + "images_webp/project_images/Score_sheet.webp"} 
            alt={repo.name}
            style={{ maxWidth: '100%', maxHeight: '100%', objectFit: 'contain', transform: `translateX(-50%) scale(${getScale(repo.name)})`, transformOrigin: 'bottom center', position: 'absolute', left: '50%', bottom: '6px' }}
          />
        ) : repo.name === 'hand_draw_simulator' ? (
          <img 
            src={import.meta.env.BASE_URL + "images_webp/project_images/Hand_draw_simulator.webp"} 
            alt={repo.name}
            style={{ maxWidth: '100%', maxHeight: '100%', objectFit: 'contain', transform: `translateX(-50%) scale(${getScale(repo.name)})`, transformOrigin: 'bottom center', position: 'absolute', left: '50%', bottom: '6px' }}
          />
        ) : repo.name === 'TicTacToe' ? (
          <img
            src={import.meta.env.BASE_URL + "images_webp/project_images/TicTacToe.webp"}
            alt={repo.name}
            style={{ maxWidth: '100%', maxHeight: '100%', objectFit: 'contain', transform: `translateX(-50%) scale(${getScale(repo.name)})`, transformOrigin: 'bottom center', position: 'absolute', left: '50%', bottom: '6px' }}
          />
        ) : (
